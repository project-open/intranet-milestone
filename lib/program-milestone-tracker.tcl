# /packages/intranet-milestone/lib/program-milestone-tracker.tcl
#
...
# Check if there is at least one correctly defined milestone in one of the projects of the program
...
set milestone_list [db_list milestone_list "
	...
	from	im_projects program,
		im_projects parent, 
		im_projects child 
	where	program.project_id = :main_project_id and 
		parent.program_id = program.project_id and
